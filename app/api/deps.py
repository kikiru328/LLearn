...
GetUserProfileUseCaseDep = Annotated[GetUserProfileUseCase, Depends(get_user_profile_usecase)]

GenerateCurriculumPreviewUseCaseDep = Annotated[GenerateCurriculumPreviewUseCase, Depends(get_generate_curriculum_preview_usecase)]
SaveCurriculumUseCaseDep = Annotated[SaveCurriculumUseCase, Depends(get_save_curriculum_usecase)]
GetUserCurriculumsUseCaseDep = Annotated[GetUserCurriculumsUseCase, Depends(get_user_curriculums_usecase)]
GetCurriculumDetailUseCaseDep = Annotated[GetCurriculumDetailUseCase, Depends(get_curriculum_detail_usecase)]
GetWeekTopicUseCaseDep = Annotated[GetWeekTopicUseCase, Depends(get_week_topic_usecase)]

CreateSummaryUseCaseDep = Annotated[CreateSummaryUseCase, Depends(get_create_summary_usecase)]
GetUserSummariesUseCaseDep = Annotated[GetUserSummariesUseCase, Depends(get_user_summaries_usecase)]
GetSummaryDetailUseCaseDep = Annotated[GetSummaryDetailUseCase, Depends(get_summary_detail_usecase)]
GetWeekSummariesUseCaseDep = Annotated[GetWeekSummariesUseCase, Depends(get_week_summaries_usecase)]

GenerateFeedbackUseCaseDep = Annotated[GenerateFeedbackUseCase, Depends(get_generate_feedback_usecase)]
GetFeedbackUseCaseDep = Annotated[GetFeedbackUseCase, Depends(get_feedback_usecase)]
GetUserFeedbacksUseCaseDep = Annotated[GetUserFeedbacksUseCase, Depends(get_user_feedbacks_usecase)]
